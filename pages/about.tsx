                ...
                <div className="flex items-center flex-wrap mb-20">
                    <div className="w-full md:w-1/2 pr-10">
                        ...
                        <p className=" dark:text-white text-gray-600 mb-8">
                            ...
                            Este software para la gestión de seguros, permite controlar detalladamente la base de datos de clientes, renovaciones de pólizas, alertas en cartera y cobranza, además del seguimiento a comisiones y tareas en general dentro de las agencias de seguro.
                        </p>
                    </div>
